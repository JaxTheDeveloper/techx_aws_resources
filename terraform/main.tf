...
# Route: Ingress VPC → Application VPC (outbound to Lambda)
...
# Route: Application VPC → Ingress VPC (return traffic)
...
# Route: Application VPC → Database VPC (Lambda initiates DB connection)
...
# Route: Database VPC → Application VPC (return traffic: query results)
